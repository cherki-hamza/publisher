        ...
        <tbody>
            <tr>
                <td align="center" bgcolor="#fff" class="" valign="top" width="100%">
                                                ...
                                                <tr class="">
                                                    <td class="">
                                                        ...
                                                        {{-- <img alt="robot picture" class="" height="155"
                                                            src="https://content.com/public/assets/images/logo.png"
                                                            width="155"> --}}
                                                    </td>
                                                </tr>
                                                <tr class="">
                                                    <td class="headline">Welcome to Pr Premium Content Writing & Placment!</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <center class="">
                                                                ...
                                                                <tbody class="">
                                                                    <tr class="">
                                                                        <td class=""
                                                                            ...
                                                                            <br><br>
                                                                            🖐 Hello {{$name}}, and welcome aboard!
                                                                            <br>
                                                                            <span style="font-weight:bold;">Email:
                                                                                &nbsp;</span><span
                                                                                style="font-weight:lighter;"
                                                                                class="">hello@overthetop.ae</span>
                                                                            <br>
                                                                            <br>
                                                                        </td>
                                                                    </tr>
                                                    ...
                                                    <td class="">
                                                        <div class="">
                                                            <a style="background-color:#674299;border-radius:4px;color:#fff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:50px;text-align:center;text-decoration:none;width:350px;-webkit-text-size-adjust:none;"
                                                                href="{{ route('index') }}">
                                                                Visit Pr Premium Content Writing & Placment!
                                                            </a>
                                                        </div>
                                                        <br>
                                                    </td>
                    ...
                    ">
                                                        <p>OTT , Sunset Mall, Jumeira 3, Dubai, UAE Click
