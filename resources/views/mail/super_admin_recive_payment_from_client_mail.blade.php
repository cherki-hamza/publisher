              ...
              <tr>
                <td class="wrapper">
                  ...
                  >
                    <tr>
                      <td>
                        <p>Hi PR  super-admin,</p>

                        <p>I hope this message finds you well And your SAAS Application well. </p>

                        <p>
                            the client name   {{ $name  }} , Email : {{$email}} Make a payment by {{$payment_platform}}  platform with value : <span style="color: #007aff;"> ${{ $value }} </span> .
                        </p>
                        <br>
