                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                {{-- start search --}}
                                <form  action="{{ route('all_disabled_publishers_search' , ['search' => request()->search ]) }}" method="POST">
                                    @csrf
                                            ...
                                            <tbody>
                                               ...
                                               <td class="text-center align-middle">
                                                @if ($site->site_language == 'Arabic')
                                                 <img width="30px" src="https://flagicons.lipis.dev/flags/4x3/sa.svg"  class="shadow">
                                                @elseif($site->site_language == 'French')
                                                <img width="30px" src="https://flagicons.lipis.dev/flags/4x3/fr.svg" class="shadow">

                                                @elseif($site->site_language == 'Chinese')
                                                <img width="30px" src="https://flagicons.lipis.dev/flags/4x3/cn.svg" class="shadow">
                                                @elseif($site->site_language == 'Japanese')
                                                <img width="30px" src="https://flagicons.lipis.dev/flags/4x3/jp.svg" class="shadow">
                                                @else
                                                <img width="30px" src="https://flagicons.lipis.dev/flags/4x3/us.svg" class="shadow">
                                                @endif
                                              ...
                                              {{-- <td class="text-center align-middle">
                                                <div class="row d-flex justify-content-center">
                                                   ...
                                                   <span><a href=""><i class="fa fa-eye text-info"></i>Delete</a></span>
                                                   </span>
                                                </div>
                                               </td>
                                             --}}
                                               <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <div class="row">
                                                        <span class="text-center mx-3">
                                                            <form action="{{ route('approve_site' , ['site_id' => $site->id]) }}" method="post">
                                                                @csrf
                                                                @method('PUT')
                                                ...
                                                @empty
                                                    <tr style="font-size: 20px" class="text-danger text-center">
                                                        <td colspan="12">Oops there is no site need Approved </span></td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
