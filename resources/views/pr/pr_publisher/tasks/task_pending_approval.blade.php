        ...
        <section class="content">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h3 class="text-center mt-3">Tasks Pending Approval</h3>
                        ...
                        <div class="d-none d-md-block pt-3 pr-3 pl-3 ml-1 mr-1">
                            <div class="btn-group nav">
                                ...
                                <a href="{{route('task_pending_approval')}}"
                                    class="btn btn-sm btn-outline-warning d-none d-md-block nav-item nav-link nav-link-faded active">Pending Approval
                    ...
                    <div class="card-header border-bottom mb-1 d-flex d-md-none">
                        <ul class="nav nav-tabs card-header-tabs nav-gap-x-1" role="tablist">
                            <li class="nav-item">
                                <a href="https://icopify.co/publisher/tasks/opentasks" class="nav-link   active"><svg
                            ...
                            <li class="nav-item">
                                <a href="https://icopify.co/publisher/tasks/progress" class="nav-link "><svg
                            ...
                            <li class="nav-item">
                                <a href="https://icopify.co/publisher/tasks/approval" class="nav-link "><svg
                            ...
                            <li class="nav-item">
                                <a href="https://icopify.co/publisher/tasks/improvement" class="nav-link "><svg
                            ...
                            <li class="nav-item">
                                <a href="https://icopify.co/publisher/tasks/awaiting" class="nav-link "><svg
                            ...
                            <li class="nav-item">
                                <a href="https://icopify.co/publisher/tasks/completed" class="nav-link "><svg
                            ...
                            <li class="nav-item">
                                <a href="https://icopify.co/publisher/tasks/rejected" class="nav-link "><svg
